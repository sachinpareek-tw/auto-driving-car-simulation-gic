...
**Tests** (with coverage, fail under 75%):

```bash
poetry run pytest tests/ --cov=src --cov-fail-under=75
```
...
If user chooses to exit, the system will show:
